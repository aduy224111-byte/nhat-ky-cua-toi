    ...
    <div id="loginPage" class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-purple-100">
            ...
            <form onsubmit="handleLogin(event)" class="space-y-5">
                <input type="text" id="loginUser" required placeholder="Tên tài khoản..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none">
                <input type="password" id="loginPass" required placeholder="Mật khẩu..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none">
                <button type="submit" class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 rounded-xl font-bold hover:opacity-90 cursor-pointer">Đăng Nhập</button>
            </form>
    ...
    <div id="registerPage" class="hidden flex items-center justify-center min-h-screen p-4">
        <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-purple-100">
            ...
            <form onsubmit="handleRegister(event)" class="space-y-5">
                <input type="text" id="regUser" required placeholder="Tên tài khoản mới..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none">
                <input type="password" id="regPass" required placeholder="Mật khẩu..." class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none">
                <button type="submit" class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 rounded-xl font-bold hover:opacity-90 cursor-pointer">Đăng Ký Ngay</button>
            </form>
